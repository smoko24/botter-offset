...
banner = "https://media.discordapp.net/attachments/1191396217419206746/1191397482849112186/988632f52a76c5e35a69dc50ece8dd9b.png?ex=65a54a5f&is=6592d55f&hm=4b8b0a867a03adadd373ce1785aae25f2c28c0ebd7b69174d120a9cf2a7544ec&=&format=webp&quality=lossless&width=550&height=550"
...
class Discord_Bot:
    ...
    def commands(self):
        ...
        async def on_ready():
            ...
            await self.bot.change_presence(activity=discord.Game(name=f"offset on top"))
        ...
        async def nuke(interaction, channel: discord.TextChannel):
            if interaction.user.guild_permissions.administrator:
                ...
                if nuke_channel is not None:
                    ...
                    embed = discord.Embed(color=embed_color, description=f"```Offset Nuke```")
                    embed.set_image(url=banner)
